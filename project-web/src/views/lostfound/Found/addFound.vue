    ...
    <el-form :model="addModel" ref="addForm" :rules="rules" label-width="120px" :inline="false" size="default">
      ...
      <el-col :span="16">
        ...
        <el-col :span="10" :offset="0">
          <el-form-item prop="lfUsername" label="拾获者：">
      ...
      <el-row style="padding-top:10px;">
        <el-col :span="10" :offset="0">
          <el-form-item prop="lfName" label="物品名称：">
            <el-input v-model="addModel.lfName"></el-input>
          </el-form-item> 
        </el-col>
        <el-col :span="10" :offset="0">
          <el-form-item prop="lfType" label="物品类型：">
      ...
      <el-row style="padding-top:10px;">
         <el-col :span="10" :offset="0">
          <el-form-item prop="lfAddress" label="拾获地址：">
            <el-input v-model="addModel.lfAddress"></el-input>
          </el-form-item>
        </el-col>     
        <el-col :span="10" :offset="0">
          <el-form-item prop="lfTime" label="拾获时间：">
      ...
      <el-col :span="8">
        <el-form-item prop="lfImg" label="物品图片：" >
...
import { foundAdd } from '@/api/found';
...
const commit = () => {
  ...
  addForm.value?.validate(async (valid) => {
    if (valid) {
      ...
      let res = await foundAdd(addModel);
      if (res && res.code == 200) {
